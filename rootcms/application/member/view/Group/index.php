...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" class="J_ajaxForm" action="{:url('Group/delete')}" method="post">
...
<volist name="data" id="vo">
    <tr>
		...
		<td align="center"><a href="{:url('Group/edit', array('groupid'=>$vo['groupid']) )}">[修改]</a></td>
    </tr>
</volist>
</tbody>
 </table>
  ...
  <div class="">
      <div class="btn_wrap_pd">             
        <button class="btn btn_submit mr10 J_ajax_submit_btn" data-action="{:url('Group/sort')}" type="submit">排序</button>
