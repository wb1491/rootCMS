      ...
      <tbody>
        <volist name="data" id="vo">
          <tr>
            ...
            <td align="left"><?php echo config("DB_PREFIX");?>{$vo.tablename}</td>
            <td align="center"><font color="red">
              <if condition=" $vo['disabled'] eq '1' ">Ⅹ
                <else />
                √</if>
              </font></td>
            <td align="center"><a href="{:url('Field/index' , array("modelid"=>$vo['modelid']) )}">字段管理</a> | <a href="{:url('Model/edit' , array("modelid"=>$vo['modelid']) )}">修改</a> | <a href="{:url('Model/move' , array("modelid"=>$vo['modelid']) )}">移动</a> | <a href="javascript:;" onClick="model_delete(this,'{$vo.modelid}','确认要删除 『 {$vo.name} 』 吗？删除后，数据表将同时被删除！',0)">删除</a></td>
          </tr>
        </volist>
      </tbody>
    </table>
