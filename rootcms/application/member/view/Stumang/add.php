      ...
      <div class="table_full">
        <table width="100%">
          ...
          <tr>
            <th>联系地址</th>
            <td>
              <input type="text" name="address" class="form-control" placeholder="联系地址" value="{$info.address}">
            </td>
          </tr>
          <tr>
            <th>备注</th>
            <td>
              <textarea class="form-control" name="bz" rows="3" placeholder="填写备注信息">{$info.bz|str_replace="<br/>","\\n",###}</textarea>
            </td>
          </tr>

          <tr>
            <th>
              <button class="btn btn-default" type="submit" name="subt1">提交</button>
            </th>
          </tr>
      </div>
    </form>
