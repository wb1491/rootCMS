...
<div class="wrap J_check_wrap">
  ...
  <form name="searchform" action="" method="get" >
    ...
    <div class="search_type cc mb10">
      <div class="mb10"> <span class="mr20"> 注册时间：
        ...
        <?php echo Form::select($viptype, (int)$_GET['vip'], 'name="vip"', 'VIP类型') ?>
  ...
  <form name="myform" action="{:url('member/delete')}" method="post" class="J_ajaxForm">
      ...
      <table width="100%" cellspacing="0">
        <thead>
          <tr>
            ...
            <td align="left">VIP等级</td>
            <td align="left">VIP到期时间</td>
            <td align="left">操作</td>
          </tr>
        </thead>
        <tbody>
          <volist name="data" id="vo">
            <tr>
              ...
              <td align="left">{$vo.vip|getVipRank=###,'typename'}</td>
              <td align="left">
                <if condition="$vo[overduedate] gt 0">
                  {$vo.overduedate|date='Y-m-d H:i:s',###}
                <elseif condition="$vo.vip gt 0"/>
                  不限时间
                <else/>
                  --
                </if>
              </td>
              <td align="left"><a href="{:url('member/edit', array('userid'=>$vo['userid']) )}">[修改]</a></td>
            </tr>
          </volist>
        </tbody>
      </table>
    ...
    <div class="">
      <div class="btn_wrap_pd">
        <button class="btn  mr10 J_ajax_submit_btn" data-action="{:url('member/member/lock')}" type="submit">锁定</button>
        <button class="btn  mr10 J_ajax_submit_btn" data-action="{:url('member/member/unlock')}" type="submit">解锁</button>
