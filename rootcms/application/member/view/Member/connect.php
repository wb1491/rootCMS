...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" action="{:url('member/connect')}" method="post">
        ...
        <tbody>
          <volist name="data" id="vo">
            <tr>
              ...
              <td align="left"><a href="javascript:confirmurl('{:url('member/connect', array('connectid'=>$vo['connectid']) )}','确认要取消绑定吗？')">[取消绑定]</a></td>
            </tr>
          </volist>
        </tbody>
      </table>
