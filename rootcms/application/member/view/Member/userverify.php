...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" action="{:url('member/userverify')}" method="post" class="J_ajaxForm">
    ...
    <div class="">
      <div class="btn_wrap_pd">
        ...
        <button class="btn  mr10 J_ajax_submit_btn" data-action="{:url('member/member/delete')}" type="submit">删除</button>
      </div>
    </div>
  </form>
</div>
