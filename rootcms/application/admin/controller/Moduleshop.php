...
class Moduleshop extends AdminBase {
    ...
    public function index() {
        ...
        if (IS_AJAX) {
            ...
            foreach ($data['data'] as $sign => $rs) {
                $version =  model('Common/Module')->where(array('sign' => $rs['sign']))->column('version');
    ...
    public function upgrade() {
        ...
        if (false === $data) {
            ...
            $version =  model('Common/Module')->where(array('sign' => $data['sign']))->column('version');
    ...
    public function public_upgrade_2() {
        ...
        $this->success('移动文件到模块目录成功，等待升级！',  url('public_upgrade_3', array('module' => $data['module'])));
    }
    ...
    public function public_step_2() {
        ...
        $this->success('移动文件到模块目录中，等待安装！',  url('public_step_3', array('module' => $data['module'])));
    }
