...
<div class="wrap">
  ...
  <table width="100%" height="100%" style="table-layout:fixed;">
    <tr class="head">
      <th><a href="{:url('Index/index')}" class="logo">管理中心</a></th>
      <td><div class="nav"> 
        ...
        <div class="login_info">
          <span class="mr10">{$role_name}： {$userInfo.username}</span>
    ...
    <tr class="tab">
      <th> <div class="search">
          <input size="15" placeholder="Hi，Manager！" id="J_search_keyword" type="text">
    ...
    <tr class="content">
      ...
      <td id="B_frame" style="height:100%;">
        ...
        <iframe id="iframe_default" src="{:url('Main/index')}" style="height: 100%; width: 100%;display:none;" data-id="default" frameborder="0" scrolling="auto"></iframe></td>
    </tr>
  </table>
</div>
...
//用于维持在线
function online(){
    $.get('<?php echo  url("admin/Index/index");?>');
}
