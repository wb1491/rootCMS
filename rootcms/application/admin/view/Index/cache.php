	...
	<div class="table_full">
		<table width="100%">
			...
			<tr>
				...
				<td>
					<a class="btn" href="{:url('Index/cache',array('type'=>'site'))}">提交</a>
				</td>
			...
			<tr>
				<th>更新站点模板缓存</th>
				<td>
					<a class="btn" href="{:url('Index/cache',array('type'=>'template'))}">提交</a>
				</td>
            ...
            <tr>
				<th>清除网站运行日志</th>
				<td>
					<a class="btn" href="{:url('Index/cache',array('type'=>'logs'))}">提交</a>
				</td>
