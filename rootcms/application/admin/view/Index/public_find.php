...
<div class="wrap"> 
  ...
  ?>
    ...
    <dl>
	  ...
	  ?>
      <dd><a class="J_search_items" href="{:url(''.$url.'',array('menuid'=>$men['id']) )}" data-id="{$men.id}{$men.app}"><?php echo str_replace($keyword,"<font color=\"red\">".$keyword."</font>",$men['name'])?></a></dd>
      <?php
	  endforeach;
	  ?>
    </dl>
