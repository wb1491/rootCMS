...
<body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <div class="table_full">
            <form method='post'   id="myform" class="J_ajaxForm"  action="{:url('Config/addition')}">
                <!--
                ...
                <table cellpadding=0 cellspacing=0 width="100%" class="table_form" >
                    <tr>
                        ...
                        <span class="gray"> http://www.linuxxt.cn 会员帐号</span></td>
                    </tr>
                    <tr>
                        <th width="140">密码:</th>
                        <td><input type="password" class="input"  name="CLOUD_PASSWORD" value="{$addition.CLOUD_PASSWORD}" size="40">
                        <span class="gray"> http://www.linuxxt.cn 会员密码</span></td>
                    </tr>
                </table>
                -->
                ...
                <table cellpadding=0 cellspacing=0 width="100%" class="table_form" >
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="input"  name="COOKIE_DOMAIN" value="{$addition.COOKIE_DOMAIN}" size="40">
                            <span class="gray"> 例如：“.linuxxt.cn”表示这个域名下都可以访问</span></td>
                    </tr>
                    <tr>
                ...
                <table cellpadding=0 cellspacing=0 width="100%" class="table_form" >
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="input"  name="SESSION_OPTIONS[domain]" value="{$addition.SESSION_OPTIONS.domain}" size="40">
                            <span class="gray"> 一般是“.linuxxt.cn”</span></td>
                    </tr>
                </table>
                ...
                <table cellpadding=0 cellspacing=0 width="100%" class="table_form" >
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="input"  name="ERROR_PAGE" value="{$addition.ERROR_PAGE}" size="40">
                            <span class="gray">例如：http://www.linuxxt.cn/error.html</span></td>
                    </tr>
                </table>
