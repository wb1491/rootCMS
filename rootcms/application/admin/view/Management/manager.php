   ...
   <table width="100%" cellspacing="0">
        ...
        <foreach name="Userlist" item="vo">
          <tr>
            ...
            <td width="10%" ><?php echo  model('admin/Role')->getRoleIdName($vo['role_id'])?></td>
            ...
            <else />
            <a href="{:url("Management/edit",array("id"=>$vo[id]))}">修改</a> | 
            <a class="J_ajax_del" href="{:url('Management/delete',array('id'=>$vo['id']))}">删除</a>
            </if>
            </td>
          </tr>
         </foreach>
