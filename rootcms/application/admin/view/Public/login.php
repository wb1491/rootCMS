...
<meta charset="utf-8" />
<title>系统后台 - {$Config.sitename}- by YNMHCMS</title>
<meta name="generator" content="ThinkPHP YNMHCMS" />
  ...
  <div class="inner">
    ...
    <div class="qzone_login clearfix">
      ...
      <div class="login_main">
        ...
        <form id="loginform" method="post" name="loginform" action="{:url('Publics/tologin')}"   >
          <ul class="login_list"  id="web_login">
            ...
            <li class="yanzhengma clearfix" id="verifytip"> <span id="verifyinput">
              ...
              <div class="yanzhengma_box" id="verifyshow"> <img class="yanzheng_img" id="code_img" alt="" src="{:url('api/Checkcode/index','code_len=4&font_size=20&width=130&height=50&font_color=&background=')}"><a href="javascript:;;" onClick="refreshs()" class="change_img">看不清，换一张</a> </div>
            </li>
            <li>
...
<div class="footer">
  <div class="inner">
    <div class="copyright clearfix">
      <p class="copyright_en">Copyright &copy; 2012 - {:date('Y')} , YNMHCMS All Rights Reserved.</p>
    </div>
  </div>
</div>
...
//刷新广告
function refreshs(){
	document.getElementById('code_img').src='{:url('api/Checkcode/index','code_len=4&font_size=20&width=130&height=50&font_color=&background=&refresh=1')}&time='+Math.random();void(0);
}
$(function(){
