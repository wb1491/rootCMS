...
class FormguideController extends AdminBase {
    ...
    protected function _initialize() {
        parent::_initialize();
        $this->db =  model("Formguide/Formguide");
    ...
    public function index() {
        if (IS_POST) {
            ...
            $this->assign("menuid", input('ger.menuid', 0, 'intval'));
    ...
    public function add() {
        if (IS_POST) {
            ...
            $this->tpl = str_replace(array("Show" . DIRECTORY_SEPARATOR, config("TMPL_TEMPLATE_SUFFIX")), "", $this->tpl);
    ...
    public function edit() {
        if (IS_POST) {
            ...
            $formid = input('get.formid', 0, 'intval');
