...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" class="J_ajaxForm" action="{:url('Info/delete')}" method="post" >
  ...
  <table width="100%" border="0" cellpadding="5" cellspacing="1" class="tableClass">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td align="center"><a href="javascript:check('{$formid}', '{$vo.dataid}', '{$vo.username}');">查看</a> | <a href="{:url('Info/delete',array('formid'=>$formid,'dataid'=>$vo['dataid']))};" class="J_ajax_del">删除</a></td>
        </tr>
       </volist>
      </tbody>
    </table>
