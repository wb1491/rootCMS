...
<div class="wrap J_check_wrap">
  <div class="nav">
    <ul class="cc">
      <li><a href="{:url("Field/index",array("formid"=>$formid))}">表单字段管理</a></li>
      <li class="current"><a href="{:url("Field/add",array("formid"=>$formid))}">添加字段</a></li>
    </ul>
  </div>
  <div class="h_a">字段配置</div>
  <form name="myform" id="myform" action="{:url("Field/add")}" method="post" class="J_ajaxForm">
