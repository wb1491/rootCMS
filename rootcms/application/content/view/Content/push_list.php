...
<div class="wrap_pop">
  <div class="nav">
    <ul class="cc">
      <li class="current"><a href="{:url('Content/Content/push',array('action'=>'position_list','modelid'=>$modelid,'catid'=>$catid,'id'=>$id))}">推送到推荐位</a></li>
      <li ><a href="{:url('Content/Content/push',array('action'=>'push_to_category','modelid'=>$modelid,'catid'=>$catid,'id'=>$id))}">推送到其他栏目</a></li>
    </ul>
  </div>
  <form class="J_ajaxForm" action="{:url('Content/push','action=position_list')}" method="post">
