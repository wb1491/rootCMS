      ...
      <div style="display:none">
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr>
              <th>内容收费设置：</th>
              <td><input type="checkbox"  value="1" <if condition="$setting[charge] eq 1">checked</if> name="setting[charge]">
                <font color=red>内容页收费； 收费标准：</font>
                <input type="text" name="setting[price]" id="price" class="input" value="{$setting[price]}">元
              </td>
            </tr>
            <tr>
              <th>前台投稿审核：</th>
          ...
          <table width="100%" class="table_form ">
            ...
            <tr id="fmmb">
              ...
              <td><select name="setting[category_template]" id="category_template">
                ...
                <span class="gray">新增模板以category_x<?php echo config("TMPL_TEMPLATE_SUFFIX")?>形式</span>
                </td>
            </tr>
            <else />
            <tr>
              ...
              <td><select name="setting[list_template]" id="list_template">
                ...
                <span class="gray">新增模板以list_x<?php echo config("TMPL_TEMPLATE_SUFFIX")?>形式</span></td>
            </tr>
            <tr  id="plmb">
              ...
              <td><select name="setting[show_template]" id="show_template">
                ...
                <span class="gray">新增模板以show_x<?php echo config("TMPL_TEMPLATE_SUFFIX")?>形式</span></td>
            </tr>
            </if>
            <tr>
              <th>后台信息列表模板：</th>
            ...
            <tr>
              ...
              <td><div class="user_group J_check_wrap">
                  ...
                  <volist name="Role_group" id="vo">
                    ...
                    <dd>
                      <label><input  class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}"  name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>   <?php echo  model("Content/CategoryPriv")->check_category_priv($privs,'init',$vo['id'],1);?> value="init,{$vo.id}" ><span>查看</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo  model("Content/CategoryPriv")->check_category_priv($privs,'add',$vo['id'],1);?> value="add,{$vo.id}" ><span>添加</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo  model("Content/CategoryPriv")->check_category_priv($privs,'edit',$vo['id'],1);?> value="edit,{$vo.id}" ><span>修改</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo  model("Content/CategoryPriv")->check_category_priv($privs,'delete',$vo['id'],1);?> value="delete,{$vo.id}" ><span>删除</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo  model("Content/CategoryPriv")->check_category_priv($privs,'listorder',$vo['id'],1);?> value="listorder,{$vo.id}" ><span>排序</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo  model("Content/CategoryPriv")->check_category_priv($privs,'push',$vo['id'],1);?> value="push,{$vo.id}" ><span>推送</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo  model("Content/CategoryPriv")->check_category_priv($privs,'remove',$vo['id'],1);?> value="remove,{$vo.id}" ><span>移动</span></label>
                    </dd>
                   </volist>
                  </dl>
                </div></td>
            ...
            <tr>
              ...
              <td><div class="user_group J_check_wrap">
                  ...
                  <volist name="Member_group" id="vo">
                    ...
                    <dd>
                      <label><input  class="J_check" type="checkbox" data-yid="J_check_priv_groupid{$vo.groupid}"  name="priv_groupid[]" <if condition=" $vo['groupid'] eq 8 "> disabled</if> <?php echo  model("Content/CategoryPriv")->check_category_priv($privs,'add',$vo['groupid'],0);?>  value="add,{$vo.groupid}" ><span>允许投稿</span></label>
                    </dd>
                   </volist>
                  </dl>
                </div></td>
