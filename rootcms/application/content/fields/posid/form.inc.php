...
function posid($field, $value, $fieldinfo) {
    ...
    $posids = array();
    if (ACTION_NAME == 'edit') {
        $result = M('PositionData')->where(array('id' => $this->id, 'modelid' => $this->modelid))->column("posid,id,catid,posid,module,modelid,thumb,data,listorder,expiration,extention,synedit");
