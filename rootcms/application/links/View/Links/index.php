...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" class="J_ajaxForm" action="{:url('Links/delete')}" method="post" >
  ...
  <table width="100%" cellspacing="0">
        ...
        <volist name="data" id="vo">
          <tr>
            ...
            <td align="center"><a href="javascript:confirmurl('{:url("Links/delete",array("id"=>$vo['id']))}','确认要删除吗？')">删除</a> | <a href="{:url("Links/edit",array("id"=>$vo['id']))}">编辑</a>
          </tr>
         </volist>
        </tbody>
      </table>
