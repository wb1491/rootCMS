...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" action="{:url("Atadmin/delete")}" method="post" class="J_ajaxForm">
  ...
  <table width="100%" cellspacing="0">
      ...
      <volist name="data" id="vo">
        <tr>
          ...
          <td align="center"><a href="javascript:preview({$vo.aid}, '{$vo.filename}','{$Config.sitefileurl}{$vo.filepath}')">预览</a> | <a class="J_ajax_del" href="{:url('Attachment/Atadmin/delete',array('aid'=>$vo['aid']))}">删除</a></td>
        </tr>
      </volist>
      </tbody>
    </table>
