...
class AttachmentsController extends Base {
    ...
    protected function _initialize() {
        ...
        if (\app\admin\service\User::getInstance()->id) {
            define('IN_ADMIN', true);
            $this->isadmin = 1;
            $this->upname = \app\admin\service\User::getInstance()->username;
            $this->upuserid = \app\admin\service\User::getInstance()->id;
        } else {
    ...
    public function competence() {
        ...
        $args = input('get.args','',"base64_decode,urldecode");
        //参数验证码
    ...
    public function swfupload_json() {
        $arr = array();
        $arr['aid'] = input('get.aid', 0, 'intval');
        $arr['src'] = input('get.src', '', 'trim');
