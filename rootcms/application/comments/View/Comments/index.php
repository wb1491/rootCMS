        ...
        <tbody>
          <volist name="data" id="vo">
            <tr>
              ...
              <td align="center"><a class="J_ajax_del" href="{:url("Comments/delete",array("id"=>$vo['id']))}">删除</a> | <a href="{:url("Comments/edit",array("id"=>$vo['id']))}">编辑</a> | <a href="{:url("Comments/replycomment",array("id"=>$vo['id']))}">回复</a> | <a href="{:url("Comments/spamcomment",array("id"=>$vo['id']))}">取消审核</a></td>
            </tr>
          </volist>
        </tbody>
      </table>
