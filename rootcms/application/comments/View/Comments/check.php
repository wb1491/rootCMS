  ...
  <form name="myform"  class="J_ajaxForm" action="" method="post" >
        ...
        <tbody>
          <volist name="data" id="vo">
            <tr>
              ...
              <td align="center"><a class="J_ajax_del" href="{:url("Comments/delete",array("id"=>$vo['id']))}">删除</a> | <a href="{:url("Comments/edit",array("id"=>$vo['id']))}">编辑</a> | <a href="{:url("Comments/spamcomment",array("id"=>$vo['id']))}">审核</a></td>
            </tr>
          </volist>
        </tbody>
      </table>
    ...
    <div class="">
      <div class="btn_wrap_pd">
        <button class="btn btn_submit mr10 J_ajax_submit_btn" data-action="{:url("Comments/Comments/check")}" type="submit">全部审核</button>
        <button class="btn  mr10 J_ajax_submit_btn" data-action="{:url("Comments/Comments/index")}" type="submit">删除</button>
      </div>
    </div>
  </form>
</div>
