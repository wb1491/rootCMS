...
<div class="wrap J_check_wrap">
  <div class="nav">
    <div class="return"><a href="{:url('Comments/Comments/config',array('menuid'=>$_GET['menuid']))}">返回评论管理</a></div>
    <ul class="cc">
      <li class="current"><a href="{:url('Comments/Emotion/index')}">表情管理</a></li>
    </ul>
  </div>
  ...
  <form class="J_ajaxForm" action="{:url('Comments/Emotion/index','action=save')}" method="post">
      ...
      <div class="table_list mb10">
        ...
        <table width="100%">
          ...
          <tr>
            ...
            <td><a href="javascript:confirmurl('{:url('Comments/Emotion/index',array('action'=>'delete','emotion_id'=>$vo['emotion_id']))}','确认要删除吗？')">[删除]</a></td>
          </tr>
          </volist>
        </table>
      </div>
  ...
  <form class="J_ajaxForm" action="{:url('Comments/Emotion/index','action=add')}" method="post">
    <div class="J_check_wrap">
      <div class="table_list mb10">
        ...
        <table width="100%">
          ...
          <tr>
            ...
            <td><a href="{:url('Comments/Emotion/index','action=add')}" class="J_emotion_add">[添加]</a></td>
          </tr>
          </volist>
        </table>
      </div>
