...
<div class="wrap J_check_wrap">
  ...
  <ul class="cc">
        ...
        <li><a href="{:url('Field/index')}">字段管理</a></li>
        <li class="current"><a href="{:url('Field/add')}">添加字段</a></li>
      </ul>
</div>
  <div class="h_a">字段属性</div>
  <form name="myform" class="J_ajaxForm" action="{:url("Comments/Field/add")}" method="post">
