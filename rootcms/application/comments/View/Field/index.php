...
<div class="wrap J_check_wrap">
  <div class="nav">
      <ul class="cc">
        ...
        <li class="current"><a href="{:url('Field/index')}">字段管理</a></li>
        <li><a href="{:url('Field/add')}">添加字段</a></li>
      </ul>
  </div>
  ...
  <table width="100%" cellspacing="0" >
      ...
      <volist name="data" id="vo">
        <tr>
          ...
          <td align='center'><a href="{:url("Comments/Field/edit",array("fid"=>$vo['fid']))}" >修改</a> | <a href="javascript:confirmurl('{:url("Comments/Field/delete",array("fid"=>$vo['fid']))}','确认要删除吗？')" >删除</a></td>
        </tr>
       </volist>
      </tbody>
    </table>
