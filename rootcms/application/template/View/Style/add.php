    ...
    <div class="wrap J_check_wrap">
        <div class="nav">
            <ul class="cc">
                ...
                <li class="current"><a href="{:url("Template/Style/add",array("dir"=>urlencode(str_replace('/','-',$dir))    ))}">在此目录下添加模板</a></li>
            </ul>
        </div>
        <div class="h_a">增加模板</div>
        <form name="myform" id="myform" action="{:url("Template/Style/add")}" method="post">
