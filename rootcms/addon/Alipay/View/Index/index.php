      ...
      <form method="post" action="{:url('Alipay/pay')}" name="form1">
        <table width="100%" border="1" cellspacing="11" cellpadding="5" bordercolor="#CCCCCC">
          ...
          <tr>
            ...
            <td><font color="#FF0000"><b>{$data.price}</b></font> 元</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><textarea name="remark" cols="38" rows="5" class="textarea" onfocus="iC(this)" placeholder="备注信息"></textarea></td>
          </tr>
          <tr>
