...
class Common_util_pub
{
	...
	public $JS_API_CALL_URL = 'http://www.linuxxt.cn/';
	
	//=======【异步通知url设置】===================================
	//异步通知url，商户根据实际开发过程设定
	public $NOTIFY_URL = 'http://www.linuxxt.cn/wxnotify.php';
	...
	function __construct($config) {
        ...
        if(empty($config)){
            $config = WxPayConf_pub::getConfig();
        }
		...
		if(isset($config['appid'])){
			...
			//=======【基本信息设置】=====================================
			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
			$this->APPID = 'wxac15c9cb1fa3ca9e';
			//受理商ID，身份标识
			$this->MCHID = '1357629802';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
			$this->KEY = '78f4ff9a9cabd1f0bbaf40d07cdbc505';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
			$this->APPSECRET = '51eb9813bde204c62c7004d33ba71fb2';		
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径
			$this->SSLCERT_PATH = 'WxPayPubHelper/cacert/apiclient_cert.pem';
			$this->SSLKEY_PATH = 'WxPayPubHelper/cacert/apiclient_key.pem';
			//商户名称
			$this->COMPANY = '壹佳科技';
...
{	
	...
	{
		//设置接口链接 https://api.mch.weixin.qq.com/pay/unifiedorder //生成订单接口URL
...
class JsApi_pub extends Common_util_pub
{
	...
	function __construct() 
	{
		//设置curl超时时间
		$this->curl_timeout = WxPayConf_pub::CURL_TIMEOUT;
		parent::__construct(WxPayConf_pub::getConfig());
	}
