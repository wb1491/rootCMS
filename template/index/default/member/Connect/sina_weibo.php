      ...
      <div  class="register_box_right">
        ...
        <ul class="clear">
         <volist name="heat" id="vo">
          <li> <a  href="{:UM('Home/index',array('userid'=>$vo['userid']))}"> <img src="{:url('api/Avatar/index',array('uid'=>$vo['userid'],'size'=>48))}" onerror="this.src='{$model_extresdir}images/noavatar.jpg'"> </a> </li>
        </volist>
        </ul>
      </div>
    </div>
