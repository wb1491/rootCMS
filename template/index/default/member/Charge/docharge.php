    ...
    WeixinJSBridge.invoke(
        ...
        function(res){
            ...
            if(res.err_msg == 'get_brand_wcpay_request:cancel') {
                ...
                alert("支付成功！");
                location.href="{:url('charged','ordersn='.$ordersn.'&price='.$price)}";
            } else {
  ...
  <div class="row indexblock">
    <div class="col-md-12 paddingfix">
      <ul class="nav nav-tabs">
        ...
        <a target="_slef" href="{:url('Charge/index')}">确认账户充值</a>
        </li>
      </ul>
...
<div class="container userprofile">
  <div class="row indexblock">
    <div class="col-md-12 paddingfix">
      <ul class="nav nav-tabs">
        <li <if condition=" !$type ">class="active"</if>>
        <a target="_slef" href="{:url('Charge/index')}">请扫描二维码</a>
        </li>
      </ul>
      <div class="tab-content border">
        <div class="row" id="favoritesList">
...
<script>
    function Check()
    {
        ...
        //var result_msg=documnet.getElementById("result").innerHTML;
        //alert(result_msg);
    }
