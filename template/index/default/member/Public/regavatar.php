...
<body>
<template file="member/Publics/regHeader.php"/>
<!--修改头像-->
<div id="modifyAvatar" class="profile" style="float: none;">
  <div class="title">会员登录</div>
  <div class="avatar_box">
    <div class="avatarTitle"> 当前头像<span>设置头像</span> </div>
    <div class="myAvatar" style="margin-left: 0;"> <img class="avatar-160" id="my-avatar" width="160" height="160" src="{:url('api/Avatar/index',array('uid'=>$uid,'size'=>180))}" onerror="this.src='{$model_extresdir}images/noavatar.jpg'"/> </div>
    <div class="myAvatarUpload">
    	<div id="myContent"></div>
        {$user_avatar}
    </div>
    <div class="style" id="next"> <a href="{:url("member/Index/home")}" id="next">下一步</a> </div>
  </div>
</div>
<template file="member/Publics/regBottom.php"/>
...
function fullAvatarCallback(msg) {
    ...
    case 5:
        if (msg.type == 0) {
            $('#my-avatar').attr('src',"{:url('api/Avatar/index',array('uid'=>$uid,'size'=>180))}");
        } else {
