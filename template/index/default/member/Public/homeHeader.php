...
<!-- avatar -->
<link href="{$config_siteurl}statics/extres/avatar/css/cropper.min.css" rel="stylesheet"/>
<link href="{$config_siteurl}statics/extres/avatar/css/main.css" rel="stylesheet"/>
<!--[if lt IE 9]>
...
<script src="{$config_siteurl}statics/extres/member/js/common.js"></script>
<script src="{$config_siteurl}statics/js/swfobject.js"></script>
<script src="{$config_siteurl}statics/extres/member/js/fullAvatarEditor.js"></script>
