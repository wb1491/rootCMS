  ...
  <div class="user_dialog_login">
    ...
    <div class="left">
      ...
      <div class="left_line">
        ...
        <div class="vcode">
          <div class="noleft"> <img id="authCode" align="absmiddle" title="看不清？点击更换" src="{:url("api/Checkcode/index","type=userlogin&code_len=4&font_size=14&width=80&height=24&font_color=&background=")}"> </div>
          <div class="reloadCode"> <a id="changeAuthCode" href="javascript:;">看不清？换一张</a> </div>
        </div>
      </div>
      </if>
      <div class="left_line">
        <div class="right"> <a href="{:url('member/Index/lostpassword')}">忘记密码?</a> </div>
        <label>
    ...
    <div class="right_line">
      ...
      <div class="reg">
        <p>赶快免费注册一个吧！</p>
        <a class="home_btn" href="{:url('Index/register')}"></a> </div>
      <div class="partner">
        <p class="tit">或使用合作网站账号登陆</p>
        <if condition=" $Member_config['qq_akey'] && $Member_config['qq_skey'] ">
        <div class="qq"> <img src="{$model_extresdir}images/icon/qqconnect.gif"> <a href="{:url('api/Connectqq/index')}">用QQ账号登陆</a> </div>
        </if>
        <if condition=" $Member_config['sinawb_akey'] && $Member_config['sinawb_skey'] ">
        <div class="sina"> <img src="{$model_extresdir}images/icon/sinaconnect.png"> <a href="{:url('api/Connectsina/index')}">用新浪微博登陆</a> </div>
        </if>
      </div>
      <p></p>
    </div>
