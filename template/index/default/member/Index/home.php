    ...
    <div class="user_main">
      ...
      <div class="uMain_home_right">
        ...
        <div class="sFriendTitle"> <span>最近访客</span>
          <p> <a  href="{:url('Relation/visitorin')}">更多</a> </p>
        </div>
        <ul class="sFriend">
           <volist name="visitors" id="vo">
            <li>
              <div class="friendAvatar"><a href="{:UM('Home/index',array('userid'=>$vo['userid']))}" class="user_card" uid="{$vo['userid']}"><img width="48" height="48" src="{:url('api/Avatar/index',array('uid'=>$vo['userid'],'size'=>48))}" onerror="this.src='{$model_extresdir}images/noavatar.jpg'"/></a></div>
        ...
        <div class="sFriendTitle"><span>关注<em>[{$friendsCount}]</em></span><p><a href="{:url('Relation/following')}">更多</a></p></div>
        <ul class="sFriend">
          <volist name="friends" id="vo">
            <li>
              <div class="friendAvatar"><a href="{:UM('Home/index',array('userid'=>$vo['fuserid']))}" class="user_card" uid="{$vo['fuserid']}"><img width="48" height="48"src="{:url('api/Avatar/index',array('uid'=>$vo['fuserid'],'size'=>48))}" onerror="this.src='{$model_extresdir}images/noavatar.jpg'"/></a></div>
